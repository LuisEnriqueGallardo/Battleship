...
class QTableros(QWidget):
    ...
    """
    def __init__(self, parent=None, botonesActivos = True, barcosActivos = ['Crucero de Asalto', 'Crucero de Asalto', 'Portaaviones', 'Portaaviones', 'Acorazado', 'Acorazado', 'Acorazado']):
    ...
    def elegirBarcos(self):
        ...
        for i, barco in self.barcosActivos:
            barco = QPushButton(barco)
            self.cuadricula.addWidget(barco, i, 11)
            barco.clicked.connect(lambda _, barco=barco: self.seleccionarTipoBarco(barco))

        for casilla in self.casillas:
            casilla.setStyleSheet("background-color: #ff040b;")
            time.sleep(0.5)
            casilla.setStyleSheet("background-color: #85C1E9;")
            time.sleep(0.5)
    
    def seleccionarTipoBarco(self, barco):
        if barco.text() == 'Crucero de Asalto':
            pass
            
        elif barco.text() == 'Portaaviones':
            pass
            
        elif barco.text() == 'Acorazado':
            pass
    ...
    def colocarBarcos(self, botonElegido):
        ...
        botonElegido.setStyleSheet("background-color: #ff8040;")
    ...
    def configurar_casilla(self, coord):
        ...
        if fila > 0:
            ...
            self.casillas[coord_arriba].setStyleSheet("background-color: Green;")
        ...
        if fila < 9:
            ...
            self.casillas[coord_abajo].setStyleSheet("background-color: Green;")
        ...
        if columna > 0:
            ...
            self.casillas[coord_izquierda].setStyleSheet("background-color: Green;")
        ...
        if columna < 9:
            ...
            self.casillas[coord_derecha].setStyleSheet("background-color: Green;")
...
class BotonBattleship(QPushButton):
    def __init__(self, row, col, parent=None):
        ...
        self.row = row
        self.col = col
        self.disparado = False  # Bandera para rastrear si se disparó en esta casilla
        self.barco = False
